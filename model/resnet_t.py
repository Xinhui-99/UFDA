...
class SupConResNet(nn.Module):
    ...
    def __init__(self, backbone='resnet18', head='mlp', feat_dim=128, num_class=0, pretrained=True, data_parallel = True):
        super(SupConResNet, self).__init__()
        model_fun, dim_in = model_dict[backbone]
        if pretrained:
            if backbone == 'resnet18':
                ...
                warnings.warn('You should chose a avaliable backbone .')
    ...
    def forward(self, x):
        ...
        return logits, F.normalize(feat_c, dim=1),discr
